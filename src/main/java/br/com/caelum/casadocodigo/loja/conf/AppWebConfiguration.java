...
import br.com.caelum.casadocodigo.loja.controller.HomeController;
...
public class AppWebConfiguration extends WebMvcConfigurerAdapter{
	...
	public MessageSource loadSource(){
	...
	public CacheManager cacheManager(){
		...
		CacheBuilder<Object, Object> builder = CacheBuilder.newBuilder() // Builder = padrão de projeto <Chave, Valor>
		.maximumSize(100)
	...
	public ViewResolver contentNegotiatingViewResolver(ContentNegotiationManager manager){
		...
		resolvers.add(internalResourceViewResolver()); // resolver de html
		resolvers.add(new JsonViewResolver()); // resolver de json - nova classe
